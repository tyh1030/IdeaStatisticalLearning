...
-- set the foreign key
-- fk1
ALTER TABLE iotrawdata ADD CONSTRAINT FK_iotrawdata_factory_id FOREIGN KEY (company_id,factory_id) REFERENCES factory(company_id,factory_id) ON UPDATE CASCADE ON DELETE RESTRICT;
-- fk2
ALTER TABLE iotrawdata ADD CONSTRAINT FK_iotrawdata_asset_id FOREIGN KEY (asset_id) REFERENCES asset(asset_id) ON UPDATE CASCADE ON DELETE RESTRICT; 
-- fk3
